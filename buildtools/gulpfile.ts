...
export const buildServer = gulp.series(sharedTasks, serverTasks, pruneCacheTask);
export const buildLang = gulp.series(sharedTasks, langTasks);
export const buildAll = gulp.series(sharedTasks, gulp.series(clientTasks, serverTasks, langTasks, pruneCacheTask));
